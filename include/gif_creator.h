...
namespace gif_creator
{
    class gif_creator
    {
      public:
        ...
        inline
        gif_creator( const std::string & p_file_name
      ...
      private:
        ...
        static inline
        const unsigned int & convert_to_gif_color( const lib_bmp::my_color_alpha & p_bmp_color
                                                 , const std::map<lib_bmp::my_color_alpha,unsigned int> & p_conversion_table
                                                 );

        static inline
        void truncate_file_name( const std::string & p_name
                               , std::string & p_result
                               );
                            ...
                            )
    {
        ...
        {
            throw quicky_exception::quicky_logic_exception("Failed to find '#' character in file patter \"" + p_file_name + "\"",__LINE__,__FILE__);
        }
        ...
        if(!l_output_file)
        {
            throw quicky_exception::quicky_runtime_exception("Unable to create file \""+l_output_file_name+"\"",__LINE__,__FILE__);
        }
